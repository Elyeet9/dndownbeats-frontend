...
export default function CreateSubcategoryCard({ onClick }: CreateSubcategoryCardProps) {
    return (
        <button
            onClick={onClick}
            className="bg-black/20 backdrop-blur-sm rounded-xl border border-dashed border-purple-400/50 hover:border-purple-400 overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 h-full flex flex-col items-center justify-center p-6 group cursor-pointer"
        >
            {/* Plus Icon */}
