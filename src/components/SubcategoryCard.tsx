...
import { deleteSubcategoryCounts, deleteSubcategory, updateSubcategory } from '@/services/SubcategoryService';
...
export default function SubcategoryCard({ subcategory, baseUrl = '', categoryId, onDelete, onUpdate }: SubcategoryCardProps) {
    ...
    const handleUpdateSubcategory = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateSubcategory(subcategory.id.toString(), {
            ...
            // Update the subcategory in parent component
            if (onUpdate) {
                onUpdate();
            }
    ...
    const handleDeleteClick = async (e: React.MouseEvent) => {
        ...
        try {
            ...
            // Get counts first
            const counts = await deleteSubcategoryCounts(subcategory.id.toString());
            setDeleteCounts(counts);
            setShowDeleteModal(true);
        } catch (error) {
            console.error('Error getting delete counts:', error);
            alert(error instanceof Error ? error.message : 'Failed to get subcategory information');
        } finally {
            setIsDeleting(false);
        }
    };
    ...
    const handleConfirmDelete = async () => {
        try {
            setIsDeleting(true);
            await deleteSubcategory(subcategory.id.toString());
            if (onDelete) {
                onDelete();
            }
    ...
    const subcategoryUrl = `/categories/${categoryId}/${subcategory.id}`;
                ...
                >
                    ...
                    >
                        <div className="flex items-center mb-6">
                            ...
                            <div>
                                <h2 className="font-display text-2xl font-bold text-white mb-1">Delete Subcategory</h2>
                        ...
                        <div className="mb-6">
                            <p className="text-gray-300 mb-4">
                                Are you sure you want to delete <span className="font-semibold text-white">&ldquo;{subcategory.name}&rdquo;</span>?
                            </p>
                            ...
                            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                                ...
                                <ul className="text-red-200 text-sm space-y-1">
                                    <li className="flex items-center">
                                        ...
                                        {deleteCounts.subcategories_count} nested subcategories
                                    </li>
                                    <li className="flex items-center">
                                        <svg className="w-4 h-4 mr-2 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
